...
class Product(models.Model):
    ...
    facilities_fir= models.CharField('facilities 1', blank=True, max_length=50, default='fa-snowflake')
    facilities_sec = models.CharField('facilities 2', blank=True, max_length=50, default='fa-car')
    facilities_th = models.CharField('facilities 3', blank=True, max_length=50, default='fa-elevator')
    facilities_fou = models.CharField('facilities 4', blank=True, max_length=50, default='fa-water-ladder')
